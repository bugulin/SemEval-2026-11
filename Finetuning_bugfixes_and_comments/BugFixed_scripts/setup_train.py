...
path_to_training_data = "train_data.json"#input('add path to the training data or add the default one: /content/my_syllogisms.jsonl')
train_dataset=load_dataset("json", data_files=path_to_training_data, split="train")
training_data_setup(path_to_training_data, "my_syllogisms.jsonl")

#loads the test data and formats them
path_to_test_data = "test_data_subtask_1.json"#input('add path to the training data or add the default one: /content/test_data_subtask_1.jsonl')
...
#setup the trainer
trainer = LoRa_configuration(model, "my_syllogisms.jsonl")
